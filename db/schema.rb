...
ActiveRecord::Schema.define(version: 2020_12_29_113316) do
  ...
  create_table "charges", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["purchase_history_id"], name: "index_charges_on_purchase_history_id"
  end
  ...
  add_foreign_key "charges", "purchase_histories"
